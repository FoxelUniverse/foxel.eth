...
export default function MintView({ address, loadWeb3Modal, price, yourLocalBalance, tokenLimit, tokenPrice, mintEnabled, currentSupply, minting, writeContracts, recentlyMinted, setMinting, tx }) {
    return (
        <div className="mint-view">
            <Space size='middle' direction="vertical">
                <h1 style={{ marginTop: '20px' }}>Mint a Foxel!</h1>
                <h3>Minting is how you create your very own Foxel.<br /> Connect a web3 wallet and press the button below.</h3>
                ...
                {address ? (
                    ...
                    >
                        {mintEnabled ? ((tokenLimit && currentSupply && tokenLimit.toString() == currentSupply.toString()) ? "All Foxels are minted" :
